# ソフトクリームファン 🍦
<p align="center">
  <img src="./images/ソフトクリームファンチラシ.jpeg" alt="つくると！10 ワークショップ用チラシ" width="720">
</p>
甘くて、涼しくて、音がなる。
ソフトクリームの形をした、CuteeWorksのオリジナルの可愛い電子工作作品です。

9V角電池で動く小さなファンに、マイコンによるPWM制御と音を組み合わせました。
ボタンを押すとソフトクリームファンのテーマ曲『ソフトクリームファン行進曲』が流れ、モーターが回転します。
